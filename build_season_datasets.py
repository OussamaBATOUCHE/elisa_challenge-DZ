...
def normalize(dataset_path):
    ...
    data.to_csv("20k_4g_data_season_normalized.csv")
        ...
        for index, row in df.iterrows():
            ...
            if source_pc not in postal_codes or destination_pc not in postal_codes:
                ...
                if lon_s is not None:
                    ...
                    e_s = count_s/lkm
                    data_set.append([lon_s, lat_s, season, e_s])
                ...
                if lon_d is not None:
                    ...
                    e_d = count_d/lkm
                    data_set.append([lon_d, lat_d, season, e_d])
...
if __name__ == "__main__":
    ...
    normalize("ready datasets/20k_4g_data_season.csv")
